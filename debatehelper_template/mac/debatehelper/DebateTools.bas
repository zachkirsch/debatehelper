...
Sub CopyCurrentCard()
    ...
    Do While True
        If Selection.Style = ActiveDocument.Styles("Tag") Then Exit Do    'Heading 8
        If Selection.Style = ActiveDocument.Styles("Sub Tag") Then Exit Do    'Heading 9
...
Sub InsertAutoText(autotextName As String)
    ...
    TemplatePath = Application.NormalTemplate.Path & ":DebateHelper.dotm"
...
Sub ShowCurrentStyle()
    ...
    If Selection.Paragraphs.Style = wdStyleHeading5 Then StyleName = "Response Level 1"
    If Selection.Paragraphs.Style = wdStyleHeading6 Then StyleName = "Response Level 2"
    If Selection.Paragraphs.Style = wdStyleHeading7 Then StyleName = "Response Level 3"
...
'Trap for user cancelling the save
    ...
    Documents.Add (Application.NormalTemplate.Path & ":Rebuttal.dotm")
